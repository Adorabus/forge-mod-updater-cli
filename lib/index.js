...
const ForgeModUpdater = require('@adorabus/forge-mod-updater')

console.log(chalk`Forge Mod Manager {magenta ${version}}`)
...
require('yargs')
  ...
  .middleware(async (argv) => {
    ...
    if (manifestExists) {
      ...
      const gameVersion = readlineSync.question(chalk`Minecraft Version: {grey (1.12.2)} `, {
        defaultInput: '1.12.2'
      })
